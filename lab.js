...
/*
  Using an if statement and a comparison operator, create code that will check
   if Amy or Brittani is older
  , and then console.log '{name} is older'. 
  Hint: Consider what will happen if they are the same age.
...
/*
  Using an if statement and a comparison operator, create code that will check if Amy
   and Brittani were
...
/*
  ...
  variable named 'lastItemRemoved'.
...
// (irrespective of whether it is true or false) and then console.
//log it's new status. It should log true. Hint: use the not operator.
...
/*
  Create a variable named 'problem9' and 
...
// Subscripting an array can fail.
// What happens if you subscript to the 7th element,
// but there are not 7 elements in the array? Now,
// use an if statement to help make sure you have the correct amount of elements,
// and then reset your variable, 'problem9' to the value of the
...
//  then check to see if the number is divisible by 3. 
